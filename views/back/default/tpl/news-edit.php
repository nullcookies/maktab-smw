<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form id="news-edit-form" role="form" action="<?=$controls['action']?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?=$news['id']?>" />
            <input type="hidden" name="alias_id" id="alias_id" value="<?=$news['alias_id']?>" />
                    ...
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <div class="form-group<?php if($errors['name'][$l_key]) { ?> has-error<?php } ?>">
                                <label for="name<?=$l_key?>"><?=$this->getTranslation('news name')?> (<?=$l_value?>)</label>
                                <input type="text" class="form-control translit-from" data-path="<?=$route?>" name="name[<?=$l_key?>]" id="name<?=$l_key?>" value="<?=$news['name'][$l_key]; ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="descr[<?=$l_key?>]" id="descr<?=$l_key?>"><?=$news['descr'][$l_key]?></textarea>
                            </div>
                            <?php } ?>
                            <?php foreach($this->lang() as $l_key => $l_value){ ?>
                            <div class="form-group">
                                <label for="descr_full<?=$l_key?>"><?=$this->getTranslation('descr full')?> (<?=$l_value?>)</label>
                                <textarea class="form-control ck-editor"  name="descr_full[<?=$l_key?>]" id="descr_full<?=$l_key?>"><?=$news['descr_full'][$l_key]; ?></textarea>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="form-control-static">
                                    <input class="flat-blue" type="checkbox" name="status" id="status" <?php if($news['status']) echo " checked "; ?> />
                                </div>
                            </div>
                            ...
                            <div class="form-group <?php if($errors['alias']) { ?>has-error<?php } ?>">
                                ...
                                <input type="text" class="form-control translit-to" name="alias" id="alias" value="<?=$news['alias']; ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="video_code" id="video_code"><?=$news['video_code']?></textarea>
                            </div>

                            <div class="form-group<?php if($errors['date']) { ?> has-error<?php } ?>">
                                <label for="date"><?=$this->getTranslation('news date')?></label>
                                <input type="text" class="form-control datepicker" name="date" id="date" value="<?=$news['date']?>" />
                                <?php if($errors['date']) { ?>
            ...
            <div class="box box-info collapse-box collapsed-box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="meta_t[<?=$l_key?>]" id="meta_t<?=$l_key?>" value="<?=$news['meta_t'][$l_key]; ?>" />
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control"  name="meta_d[<?=$l_key?>]" id="meta_d<?=$l_key?>"><?=$news['meta_d'][$l_key]; ?></textarea>
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control"  name="meta_k[<?=$l_key?>]" id="meta_k<?=$l_key?>"><?=$news['meta_k'][$l_key]; ?></textarea>
                    </div>
                    <?php } ?>
              </div><!-- /.box-body -->
            </div><!-- /.box -->
