<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$this->getTranslation('edit video');?>
    ...
    <section class="content">
        ...
        <form id="video-edit-form" role="form" action="<?=$controls['action']?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?=$video['id']?>" />
            <input type="hidden" name="alias_id" id="alias_id" value="<?=$video['alias_id']?>" />
