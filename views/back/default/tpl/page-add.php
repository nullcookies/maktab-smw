<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form id="page-add-form" role="form" action="<?=$controls['action']?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box box-success">
                        <div class="box-body">
                            ...
                            <div class="form-group<?php if($errors['name'][$l_key]) { ?> has-error<?php } ?>">
                                ...
                                <input type="text" class="form-control translit-from" data-path="<?=$this->config['alias']['page']?>" name="name[<?=$l_key?>]" id="name<?=$l_key?>" value="<?= $page['name'][$l_key]; ?>" />
                            ...
                            <div style="display: none;" class="form-group">
                                ...
                                <textarea class="form-control" name="descr[<?=$l_key?>]" id="descr<?=$l_key?>"><?= $page['descr'][$l_key]; ?></textarea>
                            </div>
                            <?php } ?>
                            <?php foreach($this->lang() as $l_key => $l_value){ ?>
                            <div class="form-group">
                    ...
                    <div class="box box-success">
                        <div class="box-body">
                            ...
                            <div class="form-group <?php if($errors['controller']) { ?>has-error<?php } ?>">
                                ...
                                <input type="text" class="form-control" name="controller" id="controller" value="<?= ($page['controller']) ? $page['controller'] : 'information' ?>" />
                            ...
                            <div class="form-group <?php if($errors['method']) { ?>has-error<?php } ?>">
                                ...
                                <input type="text" class="form-control" name="method" id="method" value="<?= ($page['method']) ? $page['method'] : 'view' ?>" />
                            ...
                            <div class="form-group <?php if($errors['side']) { ?>has-error<?php } ?>">
                                ...
                                <input type="text" class="form-control" name="side" id="side" value="front" />
                            ...
                            <div class="form-group <?php if($errors['layout']) { ?>has-error<?php } ?>">
                                ...
                                <input type="text" class="form-control" name="layout" id="layout" value="default" />
