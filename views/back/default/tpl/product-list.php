<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$this->getTranslation('product page')?>
      ...
      <div>
          <p>
              <a href="<?=$controls['add']?>" class="btn btn-app btn-success">
                <i class="fa fa-plus-circle"></i> <?=$this->getTranslation('add product')?>
              </a>
          </p>
      </div>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?=$this->getTranslation('product list')?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="data-table-ajax table table-bordered table-hover" data-ajax-url="<?=$controls['list_ajax']?>" data-order="[[ 5, &quot;desc&quot; ]]" <?php /* data-page-start="<?=$dataTableAjaxParams['page-start']?>" data-page-length="<?=$dataTableAjaxParams['page-length']?>" data-page-order-column="<?=$dataTableAjaxParams['page-order-column']?>" data-page-order-dir="<?=$dataTableAjaxParams['page-order-dir']?>" */ ?>>
                <thead>
                    <tr>
                      <th class="wh"><?=$this->getTranslation('sort.')?></th>
                      <th><?=$this->getTranslation('product name')?></th>
                      <th><?=$this->getTranslation('product category')?></th>
                      <th><?=$this->getTranslation('product price')?></th>
                      <th><?=$this->getTranslation('product quantity')?></th>
                      <th><?=$this->getTranslation('date modify')?></th>
