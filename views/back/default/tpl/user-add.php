<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form id="user-add-form" role="form" action="<?=$controls['action']?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box box-success">
                        <div class="box-body">
                            ...
                            <div class="form-group <?php if($errors['password']) { ?>has-error<?php } ?>">
                                <label for="password">
                                    <?=$this->getTranslation('password')?> <span class="text-danger">*</span>
                                </label>
                                <input type="password" class="form-control" name="password" id="password" value="<?= $user['password']; ?>" />
                                <?php if($errors['password']) { ?><div class="help-block"><?=$this->getTranslation($errors['password'])?></div><?php } ?>
                            </div>
                            ...
                            <div class="form-group <?php if($errors['usergroup']) { ?>has-error<?php } ?>">
                                ...
                                <select name="usergroup" class="form-control selectpicker">
                                    <option value=""><?=$this->t('choose usergroup', 'back')?></option>
                                    <?php if($usergroups){ ?>
